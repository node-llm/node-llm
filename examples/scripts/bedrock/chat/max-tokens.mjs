...
async function main() {
  ...
  const chat1 = llm.chat("anthropic.claude-3-5-haiku-20241022-v1:0");
  ...
  const chat2 = llm.chat("anthropic.claude-3-5-haiku-20241022-v1:0");
  ...
  const chat3 = llm.chat("anthropic.claude-3-5-haiku-20241022-v1:0");
